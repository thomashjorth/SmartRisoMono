VisualizeApp.controller('d3GaugeController', ['$scope','$interval', '$http', 'AppService', function($scope, $interval, $http, AppService, d3GaugeDirective){
	...
	$scope.init = function(host, port, aggregation, resource, titleHeading, valueMin, valueMax, placeHolder)
  	{
        ...
        $scope.data={config: {label: $scope.title, min: $scope.valueMin, max: $scope.valueMax, PlaceHolder: placeHolder},
